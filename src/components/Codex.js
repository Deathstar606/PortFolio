  ...
  return (
    <Container className="lg-container">
      ...
      <Col md={6} className="mt-3">
        <p>
          Codex is a Frontend Web Application Based on React.Data is fetched via
          a locally hosted Json Server.With Codex Users Can leave comments or
          reviews on their favourite movies and games.
        </p>
      </Col>
      ...
      >
        <div className="jumbotron">
          <Container className="lg-container">
            ...
            <Row className="mt-3">
              <Col>
                <a href="https://github.com/Deathstar606/Codex" target="_blank">
