        ...
        <Container className="mt-5">
          <Row>
            <Col md={4} className="pb-5">
              <motion.div
                className="p-2"
                style={{ position: "relative", border: "4px solid #DD6410" }}
              ...
              >
                ...
                >
                  <motion.path
                    d="M259.333 101.6C259.067 102.533 241.333 164.8 219.867 240C198.533 315.2 180.667 377.467 180.267 378.4C179.867 379.733 184 380 200 379.733L220.267 379.333L260.133 240C282 163.333 300 100.533 300 100.267C300 100.133 290.933 100 280 100C265.067 100 259.733 100.4 259.333 101.6Z"
                    fill="none"
                    stroke="#DD6410"
                    strokeWidth="7"
                  ...
                  />
                  <path
                    d="M101.067 163.6C90.6667 176.667 72.5333 199.2 61.0667 213.6L40 240L79.4667 289.467C101.333 316.667 119.733 339.2 120.533 339.467C121.467 339.867 130.533 339.867 140.933 339.733L159.733 339.333L119.867 289.733L80 240.133L118.133 192.4C139.2 166.133 157.2 143.6 158.4 142.267C160.267 140.133 159.333 140 140.267 140H120.133L101.067 163.6Z"
                    fill="#DD6410"
                    stroke="#DD6410"
                    strokeWidth="1"
                  />
                  <path
                    d="M322.267 143.067C323.6 144.667 341.6 167.2 362.267 193.067L400 240L360.267 289.6L320.533 339.333L339.2 339.733C349.467 339.867 358.533 339.733 359.467 339.467C360.4 339.067 378.8 316.667 400.533 289.467L440.133 240L400.267 190.4L360.533 140.667L340.133 140.267L319.733 139.867L322.267 143.067Z"
                    fill="#DD6410"
                    stroke="#DD6410"
                    strokeWidth="1"
                  />
                ...
                <div className="p-1">
                  <h5 className="ml-3" style={{ color: "#BCBAB8" }}>
                    Html/Css/Js
                  </h5>
            ...
            <Col md={4} className="pb-5">
              ...
              >
                ...
                >
                  ...
                  />
                  <motion.path
                    d="M305.218 132.213C291.547 138.186 288.299 156.375 298.992 167.099C314.151 182.438 339.056 168.728 335.13 147.28C332.694 134.521 317.399 126.783 305.218 132.213Z"
                    fill="none"
                    stroke="#DD6410"
                    strokeWidth="10"
                    variants={variants} // Pass the variants prop to the motion.path component
                  ...
                  />
                  <motion.path
                    d="M370.187 523.15C356.516 529.123 353.268 547.312 363.96 558.036C372.758 566.859 385.211 566.859 394.008 558.036C410.792 541.204 391.978 513.648 370.187 523.15Z"
                    fill="none"
                    stroke="#DD6410"
                    strokeWidth="10"
                    variants={variants} // Pass the variants prop to the motion.path component
                ...
                <div className="p-1">
                  ...
                  <ul style={{ color: "#BCBAB8", fontWeight: "550" }}>
                    <li>
                      Dive deep into the fundamental building blocks of
                      programming
                    </li>
                    <li>
                      Unlock the power to bring your ideas to life effortlessly
                    </li>
